...
function creatingTable(){
    ...
    var htmlContent=`<tr><td>${descriptionInput.value}</td><td>${sign} ${numberInput.value}</td><td><button class="delete-button"><i class="ion-ios-close-outline"></i></button></td></tr>`;
